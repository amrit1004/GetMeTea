  ...
  return (
    <div className="container mx-auto text-white py-14">
      ...
      <div className="flex flex-col items-center min-h-screen gap-2 p-10 ">
        ...
        <button onClick={ ()=>{signIn("github")}} className="flex items-center w-64 max-w-xs px-6 py-2 text-sm font-medium text-black border border-gray-300 rounded-lg shadow-md bg-slate-50 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
            className="w-6 h-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
